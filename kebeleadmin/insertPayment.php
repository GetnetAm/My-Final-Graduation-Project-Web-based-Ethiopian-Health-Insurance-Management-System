...
include'../connection.php';
    ...
    $insert ="INSERT INTO payment(recipt_no,customer_id,bank_name,amount,year,status) VALUES('$recipt_no','$customer_id','$bank_name','$amount','$year','$status')";


    
    if ($conn->query($insert) === true) {
             echo "New Payment is add";  echo '</br>';
        } else {
