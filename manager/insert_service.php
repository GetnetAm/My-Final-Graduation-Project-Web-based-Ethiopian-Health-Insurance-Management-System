...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Insert Service
...
<?php
	...
	$insert ="INSERT INTO service(service_id,service_name,service_discription) VALUES('$service_id','$service_name','$service_discription')";
