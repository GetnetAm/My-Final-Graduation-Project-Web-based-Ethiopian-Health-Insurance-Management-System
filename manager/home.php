...
.searchBar {
    ...
    <!-- best fontawesome -->
    <link rel="stylesheet" type="text/css" href="97%combin project ongoing/fontawesome-free-5.12.1-web/css/all.css">
