        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<a href="add_health_Center.php" class="btn">Add New Health Care</a>
						</button>
						</h1>
                    </div>
                </div>
...
include'../connection.php';
	...
	$sql = "SELECT health_center_id,health_center_name,health_center_type,casher_id,username,phone,address,agent_id FROM health_center";
